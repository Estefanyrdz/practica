					...
					nombre: {
						...
						validators: {
							...
							stringLength: {
								min: 6,
								max: 30,
								message: 'El nombre de la revista debe ser mayor de 6 y menos de 30 caracteres de largo'
							},
							regexp: {
								regexp: /^[a-zA-Z0-9]+$/,
								message: 'El nombre de la revista y sólo puede consistir en alfabético'
							}
						}
					},
					dob: {
